...
public class TC_EUP_VerifyMultiLanguage_Portuguese extends DriverFactory {
	public static final Logger logger = LogManager.getLogger("TC39_EUP_Language_Portuguese");
	@Test
	...
	public void TC39_EUP_Edit_UCD_Call_Group_(int timeout, String url, String user, String password, String fileLocation) throws Exception {
		...
		multiple.setEUPLanguage("Portuguese");		
		boolean result = verifyEUPLanguage(multiple, fileLocation);
		if(result){
			logger.info("+++++++++++++++++++++Verifying EUP language 'Portuguese' is PASSED!!!+++++++++++++++++++++");
			Reporter.log("+++++++++++++++++++++Verifying EUP language 'Portuguese' is PASSED!!!+++++++++++++++++++++");
		} else{
			logger.info("+++++++++++++++++++++Verifying EUP language 'Portuguese' is FAILED!!!+++++++++++++++++++++");
			Reporter.log("+++++++++++++++++++++Verifying EUP language 'Portuguese'is FAILED!!!+++++++++++++++++++++");
		}		
