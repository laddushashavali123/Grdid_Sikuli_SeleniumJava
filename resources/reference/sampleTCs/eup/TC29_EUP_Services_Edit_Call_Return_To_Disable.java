...
public class TC29_EUP_Services_Edit_Call_Return_To_Disable extends DriverFactory {
	public static final Logger logger = LogManager.getLogger("TC29");
	@Test
	@Parameters({"waitTime","EUP_url","EUP_user","EUP_password", "EUP_domain"})
	public void TC29_EUP_Services_Edit_Call_Return_To_Disable_(int timeout, String url, String user, String password, String domain) throws Exception {
		...
		if ( currentCallReturn.equals("Disabled") ) {
			logger.info("Set 'Call Return' as 'Enabled' before running Test case 'Edit ID call return to disable'");
			serviceT.selectCallReturn("Enabled");
		...
		if (result) {
			logger.info("--> Test case 'Edit ID call return to disable': PASSED");
			Reporter.log("--> Test case 'Edit ID call return to disable': PASSED");
		} 
		else {
			logger.info("--> Test case 'Edit ID call return to disable': FAILED");
			Reporter.log("--> Test case 'Edit ID call return to disable': FAILED");
		}
