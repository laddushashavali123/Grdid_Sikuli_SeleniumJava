...
public class TC35_EUP_Edit_Hunt_Circular_Call_Group extends DriverFactory {
	public static final Logger logger = LogManager.getLogger("TC35");
	@Test
	@Parameters({"waitTime","EUP_url","EUP_user_circular","EUP_password", "EUP_Portal_url", "EUP_Portal_user", "EUP_Portal_password", "EUP_domain"})
	public void TC35_EUP_Edit_Hunt_Circular_Call_Group_(int timeout, String url, String user, String password, String portal_url, String portal_user, String portal_password, String domain) throws Exception {
		...
		String nameOfGroup = "circularEUP";
		...
		callPage.addCallAnswerGroup_WithGroupMembers("Circular", nameOfGroup, firstNameOfSubscriber_List, firstName);
		...
		logger.info("------------------------Start Test case 'Edit hunt circular call group'------------------------");
		...
		if ( result1f ) {
			...
			GetScreenshot.capture(this.getClass().getSimpleName() + "_5_Agent_Call_Rules");
		}
		...
		if (result) {
			logger.info("--> Test case 'Edit hunt circular call group': PASSED");
			Reporter.log("--> Test case 'Edit hunt circular call group': PASSED");
		} 
		else {
			logger.info("--> Test case 'Edit hunt circular call group': FAILED");
			Reporter.log("--> Test case 'Edit hunt circular call group': FAILED");
		}
