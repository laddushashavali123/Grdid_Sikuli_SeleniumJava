...
public class TC37_EUP_Edit_Hunt_Simring_Call_Group extends DriverFactory {
	public static final Logger logger = LogManager.getLogger("TC37");
	@Test
	@Parameters({"waitTime","EUP_url","EUP_user_simring","EUP_password", "EUP_Portal_url", "EUP_Portal_user", "EUP_Portal_password", "EUP_domain"})
	public void TC37_EUP_Edit_Hunt_Simring_Call_Group_(int timeout, String url, String user, String password, String portal_url, String portal_user, String portal_password, String domain) throws Exception {
		...
		callPage.addCallAnswerGroup_WithGroupMembers("Simring", nameOfGroup, firstNameOfSubscriber_List, firstName);
		...
		logger.info("------------------------Start Test case 'Edit hunt simring call group'------------------------");
...
/*		logger.info("EUP - Set 'Agent Call Rules' as '" + agentCallRules + "'" );
		addCallPage.setAgentCallRules(agentCallRules);*/  /*This option is removed*/
		...
		if ( result1e ) {
			...
			GetScreenshot.capture(this.getClass().getSimpleName() + "_5_NoAnswerAction");
		}
		...
		if ( result1f ) {
			...
			GetScreenshot.capture(this.getClass().getSimpleName() + "_6_AgentCallRules");
		}*/  /*This options is removed*/
