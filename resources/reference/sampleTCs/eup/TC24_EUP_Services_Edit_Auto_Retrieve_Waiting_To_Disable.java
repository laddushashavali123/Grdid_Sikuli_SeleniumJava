...
public class TC24_EUP_Services_Edit_Auto_Retrieve_Waiting_To_Disable extends DriverFactory {
	public static final Logger logger = LogManager.getLogger("TC24");
	@Test
	@Parameters({"waitTime","EUP_url","EUP_user","EUP_password", "EUP_domain"})
	public void TC24_EUP_Services_Edit_Auto_Retrieve_Waiting_To_Disable_(int timeout, String url, String user, String password, String domain) throws Exception {
		...
		if (result) {
			logger.info("--> Test case 'Edit ID auto retrieve waiting to disable': PASSED");
			Reporter.log("--> Test case 'Edit ID auto retrieve waiting to disable': PASSED");
		} 
		else {
			logger.info("--> Test case 'Edit ID auto retrieve waiting to disable': FAILED");
			Reporter.log("--> Test case 'Edit ID auto retrieve waiting to disable': FAILED");
		}
