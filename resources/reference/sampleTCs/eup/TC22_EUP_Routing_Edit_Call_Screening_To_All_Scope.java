...
public class TC22_EUP_Routing_Edit_Call_Screening_To_All_Scope extends DriverFactory {
	public static final Logger logger = LogManager.getLogger("TC21");
	@Test
	@Parameters({"waitTime","EUP_url","EUP_user","EUP_password", "EUP_domain"})
	public void TC22_EUP_Routing_Edit_Call_Screening_To_All_Scope_(int timeout, String url, String user, String password, String domain) throws Exception {
		...
		if (result) {
			logger.info("--> Test case ''Edit call screening all scope': PASSED");
			Reporter.log("--> Test case ''Edit call screening all scope': PASSED");
		} 
		else {
			logger.info("--> Test case ''Edit call screening all scope': FAILED");
			Reporter.log("--> Test case ''Edit call screening all scope': FAILED");
		}
