...
public class TC_004_SMBLevel_HelpPartWillUpdateTheMaxQueueTimeTo5400ForUCDGroup extends DriverFactory{
	public static final Logger logger = LogManager.getLogger("TC_004_SMBLevel_HelpPartWillUpdateTheMaxQueueTimeTo5400ForUCDGroup");
	@Test
	@Parameters({"waitTime","Partner_url","Partner_user","Partner_password","UCD_SMB_customer", "UCD_MaxWaitTime"})
	public void OrgLevel_CreateUCDGroupWithMaxQueueTimeTo5400(int waitTime, String url, String user, String password, String customer, String maxWaitTime) throws Exception {
		...
		logger.info("Search customer '" + customer + "' and right click");
