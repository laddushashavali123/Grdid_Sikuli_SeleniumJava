...
public class TC_000_PreConfigure extends DriverFactory{
	...
	public void AddOrganizationCustomerRootDomainNormal(int waitTime, String url, String user, String password, String cusName, String smbName, String subName, String language) throws Exception {
		...
		Logout logout = new Logout(driver, waitTime);
		logout.quitCustomerLeftClick();
		
		logger.info("Search for customer: "+ smbName);
		menubefore.searchCustomer(smbName);
		ChangeSiteLanguage(driver, waitTime, "smbsite", language);
	}
