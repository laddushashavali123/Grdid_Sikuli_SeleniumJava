...
public class TC_005_ORGCreateSubsWithPortugueseLanguage  extends DriverFactory{
	public static final Logger logger = LogManager.getLogger("TC_005_ORG_Create_Update_Delete_SubsWithPortugueseLanguage");
	@Test
	@Parameters({"waitTime","Partner_url","Partner_user","Partner_password", "ORG_name", "new_Sub_name", "Language"})
	public void createSMBWithLanguageIsPortuguese(int waitTime, String url, String user, String password, String cusName, String userID, String language) throws Exception {
		...
		if(!addsub.verifyCreatedSubscriberByAlert()){
			TC_005 = false;
			logger.error("**TC Result: TC_009_ORGCreateSubsWith"+language+"Languagez: Verify adding Subscriber with userID by Alert: FAILED**");
			Reporter.log("**TC Result: TC_009_ORGCreateSubsWith"+language+"Languagez: Verify adding Subscriber with userID by Alert: FAILED**");
		}
		...
		if(!subscriber.verifyAddingSubscriber(userID)){
			TC_005 = false;
			logger.error("**TC Result: TC_009_ORGCreateSubsWith"+language+"Languagez: Verify adding Subscriber with userID: FAILED**");
			Reporter.log("**TC Result: TC_009_ORGCreateSubsWith"+language+"Languagez: Verify adding Subscriber with userID: FAILED**");
		} else{			
			...
			if(!addsub.verifyDefaultLanguage(logger, language)){
				TC_005 = false;
				logger.error("**TC Result: TC_009_ORGCreateSubsWith"+language+"Language: Verify adding Subscriber with default language: FAILED**" + addsub.getDefaultLanguage());				
				Reporter.log("**TC Result: TC_009_ORGCreateSubsWith"+language+"Language: Verify adding Subscriber with default language: FAILED**" + addsub.getDefaultLanguage());
			} 
		...
		WebUtil.waitFor_LoadingFinished(driver, waitTime);
		if(!subscriber.VerifyAlertMessage("subscriber removed.")){
			Reporter.log("Alert message is not correct");
		}
		...
		if(!subscriber.verifyRemovingSubscriber(userID)){
			TC_007 = false;
			logger.error("**TC Result: TC_011_ORGRemoveSubsWith"+language+"Language: Verify Removing Subscriber with userID: FAILED**");
			Reporter.log("**TC Result: TC_011_ORGRemoveSubsWith"+language+"Language: Verify Removing Subscriber with userID: FAILED**");
		}
		logger.info("Removing a subscriber successfully");

		// Echo Results
		if(TC_005){
			logger.info("**TC Result: TC_009_ORGCreateSubsWith"+language+"Language finished successfully with Result is : PASSED**");
			Reporter.log("**TC Result: TC_009_ORGCreateSubsWith"+language+"Language finished successfully with Result is : PASSED**");
		} else{
			logger.info("**TC Result: TC_009_ORGCreateSubsWith"+language+"Language finished successfully with Result is : FAILED**");
			Reporter.log("**TC Result: TC_009_ORGCreateSubsWith"+language+"Language finished successfully with Result is : FAILED**");
		}
		if(TC_006){
			logger.info("**TC Result: TC_010_ORGChangeLanguageForSubsFromEnglishTo"+language+"AndVersa finished successfully with Result is : PASSED**");
			Reporter.log("**TC Result: TC_010_ORGChangeLanguageForSubsFromEnglishTo"+language+"AndVersa finished successfully with Result is : PASSED**");
		} else{
			logger.info("**TC Result: TC_010_ORGChangeLanguageForSubsFromEnglishTo"+language+"AndVersa finished successfully with Result is : FAILED**");
			Reporter.log("**TC Result: TC_010_ORGChangeLanguageForSubsFromEnglishTo"+language+"AndVersa finished successfully with Result is : FAILED**");
		}
		if(TC_007){
			logger.info("**TC Result: TC_011_ORGRemoveSubsWith"+language+"Language finished successfully with Result is : PASSED**");
			Reporter.log("**TC Result: TC_011_ORGRemoveSubsWith"+language+"Language finished successfully with Result is : PASSED**");
		} else{
			logger.info("**TC Result: TC_011_ORGRemoveSubsWith"+language+"Language finished successfully with Result is : FAILED**");
			Reporter.log("**TC Result: TC_011_ORGRemoveSubsWith"+language+"Language finished successfully with Result is : FAILED**");
		}
